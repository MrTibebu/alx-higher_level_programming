...
OBOBOBclass TestRectangle_area(unittest.TestCase):
    """Unittests for testing the area method of the Rectangle class."""
OBOBOBOBOBOBOBOBOB
    def test_area_small(self):
OBOBOB        r = Rectangle(10, 2, 0, 0, 0)
OBOBOBOBOBOB        self.assertEqual(20, r.area())
...
OAOAOA
OAOAOAOAOAOA    def test_area_one_arg(self):
OAOAOA        r = Rectangle(2, 10, 1, 1, 1)
